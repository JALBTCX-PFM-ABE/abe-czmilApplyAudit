  ...
  QWizardPage (parent)
{
  ...
  setTitle (tr ("czmilApplyAudit File Input"));
...
{
  QFileDialog fd (this, tr ("czmilApplyAudit Input files"));
  fd.setViewMode (QFileDialog::List);
  fd.setDirectory (input_dir);

  fd.setFileMode (QFileDialog::ExistingFiles);
  fd.setNameFilter (tr ("CZMIL CAF (*.caf)"));
...
{
  QString title = tr ("czmilApplyAudit Input directories");
