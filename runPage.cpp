  ...
  QWizardPage (parent)
{
  ...
  progress->fbox = new QGroupBox (tr ("Current file processing progress"), this);
  ...
  progress->fbar->setWhatsThis (tr ("Progress of the processing of the current input data file."));
